        ...
        <div className="page exec-summary-page">
            <div className="content-container">
                ...
                <div style={{
                    ...
                    <p>
                        The European outdoor kitchen market has a gap. At the bottom: cheap, low-quality carts that deteriorate within seasons. At the top: bespoke luxury kitchens at <strong>€15,000–€50,000</strong>, out of reach for most households. In between, the "Missing Middle" from <strong>€3,000 to €5,000</strong>, no scaled player exists. This is a <strong>€110M</strong> opportunity across the Netherlands, Belgium, and Germany, and Fieldsman is positioned to capture it.
                    </p>
                    ...
                    <p>
                        Fieldsman has proven product-market fit, with almost no marketing. The company sells around <strong>50-75</strong> kitchens annually, generating <strong>€150-200K</strong> revenue at <strong>40%</strong> margins, on less than <strong>€5,000</strong> in advertising spend. Demand exceeds supply: we stop advertising each May because we cannot fulfill orders, not because demand weakens. The constraint is operational, not commercial. If <strong>€5K</strong> in advertising generates <strong>€200K</strong> in revenue, the opportunity to scale through professional marketing is enormous.
                    </p>
                    ...
                    <ul style={{ paddingLeft: '12px', listStyleType: 'disc', margin: 0, display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        <li>
                            <strong>First, production transformation.</strong> Redesign the product into a modular system enabling mass customization. Outsource steel frames to China (scalable, stockable) and invest in waterjet cutting to bring countertop production in-house, addressing the true bottleneck where the supplier market fails on cost (<strong>€900 → €100</strong>) and lead time (<strong>8 weeks → 2 weeks</strong>). This unlocks capacity from <strong>50 to 5,000</strong> kitchens per year.
                        </li>
                        <li>
                            <strong>Second, a professional multi-channel marketing engine.</strong> Scaling from <strong>€200K to €22–35M</strong> requires more than increasing ad spend. It demands a full marketing transformation: SEO to capture high-intent search traffic, paid social campaigns on Instagram and Pinterest where outdoor living inspiration happens, strategic influencer partnerships with kamado and outdoor lifestyle creators, presence at garden and BBQ events, and targeted paid advertising across Meta and Google. Equally important is building brand legitimacy through systematic collection of online reviews and customer testimonials, creating a moat of social proof that competitors cannot easily replicate.
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Fourth, phased geographic expansion.</strong> Scale the Netherlands in <strong>2026</strong>. Enter Belgium and pilot Germany in <strong>2027</strong>. Accelerate Germany, the anchor market at <strong>€251M</strong> TAM, through <strong>2030</strong>.
                        </li>
                    </ul>

                    <p>
                        The financial outcome is compelling. Revenue grows from <strong>€200K (2025)</strong> to <strong>€22–35M (2030)</strong>. Volume scales from <strong>50</strong> to <strong>2,200–3,400</strong> kitchens per year. EBITDA margins reach <strong>35–36%</strong> as operating leverage builds.
                    </p>
