        ...
        <>
            ...
            <PageWrapper sectionLabel="SECTION 4: STRATEGIC OPTIONS">
                ...
                <div style={{ marginBottom: 'var(--space-6)' }}>
                    <TextBlock>
                        <p style={{ fontSize: 'var(--font-size-body)' }}>
                            To determine the optimal path for national scale and international expansion, Fieldsman utilized the Odyssey 3.14 framework to generate three distinct Business Model Innovation vectors. These options challenge the current model across its three pillars: Value Proposition, Value Architecture, and Profit Equation.
                        </p>
                    </TextBlock>
                </div>
                ...
                <div style={{ marginTop: 'var(--space-4)' }}>
                    <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 'var(--font-size-small)', tableLayout: 'fixed' }}>
                        {/* HEADER: OPTIONS */}
                        <thead style={{ background: 'var(--color-neutral-50)' }}>
                            <tr>
                                <th style={{ width: '15%', background: 'white', border: 'none' }}></th>
                                <th style={{ textAlign: 'left', padding: 'var(--space-2)', width: '28.33%', color: 'var(--color-primary)', fontWeight: 800, borderBottom: '2px solid var(--color-neutral-200)', borderTop: '4px solid var(--color-primary)', borderLeft: '1px solid var(--color-neutral-200)', background: 'var(--color-neutral-100)' }}>
                                    OPTION 1 <br></br> BRAND SCALE-UP
                                    <div style={{ fontSize: 'var(--font-size-tiny)', fontWeight: 600, color: 'var(--color-primary)', marginTop: '2px', textTransform: 'uppercase' }}>Value Architecture Innovation</div>
                                </th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style={{ padding: 'var(--space-2)', fontWeight: 700, color: 'var(--color-neutral-800)', borderBottom: '1px solid var(--color-neutral-200)', background: 'var(--color-neutral-50)', verticalAlign: 'top' }}>
                                    STRATEGIC<br />LOGIC
                                </td>
                                <td style={{ padding: 'var(--space-2)', color: 'var(--color-primary)', borderBottom: '1px solid var(--color-neutral-200)', borderLeft: '1px solid var(--color-neutral-200)', verticalAlign: 'top', background: 'var(--color-neutral-100)', lineHeight: '1.4' }}>
                            ...
                            {['Suitability', 'Feasibility', 'Acceptability', 'Ops Control'].map((crit, idx) => (
                                <tr key={crit} style={{ borderBottom: idx === 3 ? '1px solid var(--color-neutral-200)' : '1px dashed var(--color-neutral-200)' }}>
                                    <td style={{ padding: '6px 8px', fontWeight: 600, fontSize: 'var(--font-size-small)', color: 'var(--color-neutral-600)', background: 'var(--color-neutral-50)' }}>{crit}</td>
            ...
            <PageWrapper sectionLabel="SECTION 4: STRATEGIC OPTIONS">
                ...
                <div style={{ marginBottom: 'var(--space-6)' }}>
                    <h3 style={{ fontSize: 'var(--font-size-h4)', fontWeight: 800, color: 'var(--color-neutral-600)', marginBottom: 'var(--space-2)', letterSpacing: '0.05em' }}>STRATEGIC INTENT: THE "PHYGITAL" ENGINE</h3>
                    <TextBlock>
                        <p style={{ fontSize: 'var(--font-size-body)', color: 'var(--color-neutral-700)', lineHeight: '1.6' }}>
                            Fieldsman will build a scalable European outdoor kitchen brand by executing a repeatable D2C "phygital" model: leveraging online inspiration and digital configurators for customer acquisition, supported by cost-efficient physical experience points. This strategy transforms the supply chain by leveraging modular architecture to shift from high-cost local fabrication to a hybrid assembly model (Chinese component scale + Dutch precision finishing), enabling national and international growth without proportional headcount increases.
                        </p>
                    </TextBlock>
                </div>
                ...
                <div style={{ marginBottom: 'var(--space-6)' }}>
                    <h3 style={{ fontSize: 'var(--font-size-h4)', fontWeight: 800, color: 'var(--color-neutral-600)', marginBottom: 'var(--space-3)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>TARGETED OUTCOMES BY 2030</h3>
                ...
                <div style={{ borderTop: '2px solid var(--color-neutral-200)', paddingTop: 'var(--space-4)', marginTop: 'auto' }}>
                    <h3 style={{ fontSize: 'var(--font-size-h4)', fontWeight: 800, color: 'var(--color-neutral-600)', marginBottom: 'var(--space-2)', letterSpacing: '0.05em' }}>4.3 KEY TAKEAWAYS</h3>
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-5)' }}>
