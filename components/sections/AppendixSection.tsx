    ...
    return (
        <React.Fragment>
            ...
            <PageWrapper sectionLabel="APPENDIX">
                ...
                <div style={{ marginTop: 'var(--space-8)', background: 'var(--color-neutral-50)', padding: 'var(--space-5)', borderRadius: 'var(--border-radius-md)', border: '1px solid var(--color-neutral-200)' }}>
