    ...
    return (
        <React.Fragment>
            ...
            <PageWrapper sectionLabel="APPENDIX">
                ...
                <div style={{ marginTop: 'var(--space-8)', background: '#F8FAFC', padding: 'var(--space-5)', borderRadius: 'var(--border-radius-md)', border: '1px solid #E2E8F0' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 'var(--space-4)' }}>
                        <div style={{ background: 'white', padding: 'var(--space-3)', border: '1px solid #E2E8F0', borderRadius: '4px' }}>
                            <div style={{ fontSize: '9px', fontWeight: 800, color: 'var(--color-primary-main)' }}>ENTRY</div>
                            <div style={{ fontSize: '15px', fontWeight: 800, margin: '2px 0' }}>€2,000+</div>
                            <div style={{ fontSize: '10px', color: '#64748b' }}>2 modules. Targets price-sensitive first-time buyers.</div>
                        </div>
                        <div style={{ background: 'white', padding: 'var(--space-3)', border: '1.5px solid var(--color-primary-main)', borderRadius: '4px', position: 'relative' }}>
                            <div style={{ fontSize: '9px', fontWeight: 800, color: 'var(--color-primary-main)' }}>CORE</div>
                            <div style={{ fontSize: '15px', fontWeight: 800, margin: '2px 0' }}>€3k – €5k</div>
                            <div style={{ fontSize: '10px', color: '#64748b' }}>4–6 modules. Primary mid-premium target segment.</div>
                        </div>
                        <div style={{ background: 'white', padding: 'var(--space-3)', border: '1px solid #E2E8F0', borderRadius: '4px' }}>
                            <div style={{ fontSize: '9px', fontWeight: 800, color: 'var(--color-primary-main)' }}>PREMIUM</div>
                            <div style={{ fontSize: '15px', fontWeight: 800, margin: '2px 0' }}>€6k – €10k</div>
                            <div style={{ fontSize: '10px', color: '#64748b' }}>8+ modules. Design-driven, full outdoor kitchen.</div>
                        </div>
                    </div>
                </div>

                <div style={{ marginTop: 'var(--space-8)', background: 'var(--color-neutral-900)', color: 'white', padding: 'var(--space-8)', borderRadius: 'var(--border-radius-lg)', position: 'relative', overflow: 'hidden' }}>
                    <div style={{ position: 'relative', zIndex: 1 }}>
                        <h3 style={{ color: 'var(--color-secondary-main)', fontSize: '16px', marginBottom: 'var(--space-3)' }}>The Modularity Moat</h3>
                    ...
                    {/* Decorative element */}
                    <div style={{ position: 'absolute', right: '-20px', top: '-20px', width: '150px', height: '150px', background: 'var(--color-primary-main)', opacity: 0.1, borderRadius: '50%' }} />
                </div>
            </PageWrapper>
        </React.Fragment>
    );
