                ...
                <div className="grid-container">
                    ...
                    <div className="col-6">
                        ...
                        <TextBlock>
                            ...
                            <p style={{ marginBottom: 'var(--space-3)' }}>
                                The company is currently operated part-time alongside the founders' professional activities, supported by approximately 3–5 part-time employees. Despite this setup, Fieldsman has demonstrated clear market traction: approximately 40 kitchens per year, generating around €170K in revenue and €83K in EBITDA, on approximately €10K in marketing spend. These results indicate strong product-market fit and a margin structure that can fund growth.
                            </p>
                            <p style={{ marginBottom: 'var(--space-3)' }}>
