            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', position: 'relative' }}>
                ...
                <div style={{ position: 'relative', zIndex: 1, background: '#FAF9F6', border: '1px solid #C8B696', borderRadius: '6px', padding: '12px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '8px' }}>
                        <MetricCard title="SEO & Content" target="30 to 40% of Traffic" text="High-intent organic capture at near-zero marginal cost" color="#546E35" />
                        <MetricCard title="Paid Social" target="4 to 6x ROAS" text="Lifestyle-driven prospecting and retargeting on Meta and Pinterest" color="#546E35" />
                        <MetricCard title="Influencers" target="15 to 20% Referral" text="Authentic validation through outdoor cooking and lifestyle creators" color="#546E35" />
                        <MetricCard title="Experiential" target="5 to 10 Events per Year" text="Physical lead generation at high-intent garden and BBQ shows" color="#546E35" />
                        <MetricCard title="Review Moat" target="600+ Reviews" text="Structural trust advantage through systematic review collection" color="#546E35" bg="#F2EBD4" />
                    </div>
                </div>
                ...
                <div style={{ position: 'relative', zIndex: 1, background: '#FAF9F6', border: '1px solid #A69475', borderRadius: '6px', padding: '12px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px' }}>
                        <FeatureBlock title="AI Configurator" text="Real-time assistant that resolves compatibility questions and enables upsells" outcome="+20% Completion" color="#A69475" />
                        <FeatureBlock title="Intelligent Qualification" text="Lead scoring that focuses sales effort on the top 30% of prospects" outcome="High Efficiency" color="#A69475" />
                        <FeatureBlock title="Auto-Service" text="Handles 85% of customer queries instantly around the clock" outcome="Under 5 Min Response" color="#A69475" />
                    </div>
                </div>
                ...
                <div style={{ position: 'relative', zIndex: 1, background: '#FAF9F6', border: '1px solid #E6DDBF', borderRadius: '6px', padding: '12px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                        <div style={{ padding: '8px', background: 'rgba(255,255,255,0.6)', borderRadius: '4px', border: '1px solid #E6DDBF' }}>
                            ...
                            <p style={{ fontSize: '9px', color: '#64748b', lineHeight: '1.3' }}>Complementary retail partners in garden and BBQ sectors at <strong>5 to 15% fee</strong> versus 40% traditional retail margin</p>
                        </div>
                        <div style={{ padding: '8px', background: 'rgba(255,255,255,0.6)', borderRadius: '4px', border: '1px solid #E6DDBF' }}>
                            <div style={{ fontSize: '10px', fontWeight: 800, color: '#A69475', marginBottom: '4px' }}>Showroom-Light Model</div>
                            <p style={{ fontSize: '9px', color: '#64748b', lineHeight: '1.3' }}>Fewer locations offset by high-resolution content, social proof, and strategic pop-up events</p>
                        </div>
                    </div>
                </div>
